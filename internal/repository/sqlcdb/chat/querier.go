...
type Querier interface {
	...
	ListCasesPaged(ctx context.Context, arg ListCasesPagedParams) ([]ListCasesPagedRow, error)
	ListGuestsWithLastCase(ctx context.Context, arg ListGuestsWithLastCaseParams) ([]ListGuestsWithLastCaseRow, error)
