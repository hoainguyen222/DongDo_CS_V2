...
func (r *PartnerRepo) ListRolePermissions(ctx context.Context) ([]*domain.RolePermission, error) {
	return []*domain.RolePermission{
		{ID: 1, RoleName: "Owner", FeatureKey: "dashboard", CanView: true, CanEdit: true, UpdatedAt: time.Now()},
		{ID: 2, RoleName: "Leader CS", FeatureKey: "dashboard", CanView: true, CanEdit: true, UpdatedAt: time.Now()},
		{ID: 3, RoleName: "Staff CS", FeatureKey: "dashboard", CanView: true, CanEdit: false, UpdatedAt: time.Now()},
	}, nil
}
